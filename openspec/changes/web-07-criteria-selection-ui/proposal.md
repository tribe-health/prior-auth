...
The web application cannot perform its central case-to-letter workflow. Bind the effective criteria snapshot and mount policy and pathway selection views.

## What Changes

- Bind the effective criteria snapshot and mount policy and pathway selection views.
...
- `criteria-selection-ui`: Bind the effective criteria snapshot and mount policy and pathway selection views.
