...
The web application cannot perform its central case-to-letter workflow. Run child Tier 2 and certify the complete local browser workflow.

## What Changes

- Run child Tier 2 and certify the complete local browser workflow.
...
- `browser-scenario-certification`: Run child Tier 2 and certify the complete local browser workflow.
