...
The web application cannot perform its central case-to-letter workflow. Publish approved case summaries and mount responsive case queue, detail, and intake views.

## What Changes

- Publish approved case summaries and mount responsive case queue, detail, and intake views.
...
- `case-publication-ui`: Publish approved case summaries and mount responsive case queue, detail, and intake views.
