...
The web application cannot perform its central case-to-letter workflow. Assemble one durable sourced met, gap, and void evidence revision.

## What Changes

- Assemble one durable sourced met, gap, and void evidence revision.
...
- `evidence-assembly-core`: Assemble one durable sourced met, gap, and void evidence revision.
