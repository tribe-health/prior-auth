...
The web application cannot perform its central case-to-letter workflow. Generate cited corrected-resubmission and clinical-appeal response drafts.

## What Changes

- Generate cited corrected-resubmission and clinical-appeal response drafts.
...
- `response-letter-command`: Generate cited corrected-resubmission and clinical-appeal response drafts.
