...
function QuestionnaireProgress({
  ...
  return (
    <QuestionnairePrimitive.Progress
      ...
      className={cn(
        "min-h-[1lh] w-fit min-w-[14ch] text-xs font-medium text-ui-muted-foreground tabular-nums",
        className
      )}
      {...props}
    />
...
function QuestionnaireDescription({
  ...
  return (
    <QuestionnairePrimitive.Description
      ...
      className={cn("text-sm text-pretty text-ui-muted-foreground", className)}
      {...props}
    />
  )
}
  ...
  return (
    ...
    >
      ...
      <QuestionnairePrimitive.ChoiceShortcut
        ...
        className="pointer-events-none ms-auto hidden size-5 shrink-0 translate-y-[--spacing(0.45)] items-center justify-center rounded-md border border-input bg-background font-mono text-[0.625rem] leading-none font-medium text-ui-muted-foreground group-has-data-[slot=questionnaire-choice-description]/questionnaire-choice:translate-y-0.5 group-data-[shortcut]/questionnaire-choice:inline-flex"
      />
    </QuestionnairePrimitive.Choice>
  )
}
    ...
    >
      <QuestionnairePrimitive.Input
        ...
        className={cn(
          ...
          "selection:bg-primary selection:text-primary-foreground placeholder:text-ui-muted-foreground",
          className
        )}
        {...props}
      />
