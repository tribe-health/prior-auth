...
const reasoningVariants = cva("aui-reasoning-root mb-4 w-full", {
  variants: {
    variant: {
      ...
      ghost: "",
      muted: "bg-ui-muted/50 rounded-lg px-3 py-2",
    },
  },
  defaultVariants: {
    variant: "outline",
...
function ReasoningTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-reasoning-trigger group/trigger text-ui-muted-foreground hover:text-foreground flex max-w-[75%] origin-left items-center gap-2 py-1.5 text-sm transition-[color,scale] active:scale-[0.98]",
        className,
      )}
      {...props}
    >
...
function ReasoningContent({
  ...
  return (
    <CollapsibleContent
      ...
      className={cn(
        "aui-reasoning-content text-ui-muted-foreground relative overflow-hidden text-sm outline-none",
