...
const toolGroupVariants = cva("aui-tool-group-root group/tool-group w-full", {
  variants: {
    variant: {
      ...
      ghost: "",
      muted: "border-ui-muted-foreground/30 bg-ui-muted/30 rounded-lg border py-3",
    },
  },
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        ...
        "group-data-[variant=ghost]/tool-group-root:text-ui-muted-foreground group-data-[variant=ghost]/tool-group-root:hover:text-foreground group-data-[variant=ghost]/tool-group-root:py-1.5",
