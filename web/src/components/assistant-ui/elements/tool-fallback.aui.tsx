...
function ToolFallbackDuration({
  ...
  return (
    <span
      ...
      className={cn(
        "aui-tool-fallback-duration text-ui-muted-foreground text-xs tabular-nums",
        className,
      )}
      {...props}
    >
...
function ToolFallbackTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-tool-fallback-trigger group/trigger text-ui-muted-foreground hover:text-foreground flex w-fit origin-left items-center gap-2 py-1.5 text-sm transition-[color,scale] active:scale-[0.98]",
        className,
      )}
      {...props}
    >
      <Icon
        ...
        className={cn(
          ...
          isCancelled && "text-ui-muted-foreground",
      ...
      <span
        ...
        className={cn(
          ...
          isCancelled && "text-ui-muted-foreground line-through",
...
function ToolFallbackArgs({
  ...
  return (
    <div
      ...
      {...props}
    >
      <pre className="aui-tool-fallback-args-value bg-ui-muted/50 text-foreground/90 rounded-md p-2.5 text-xs whitespace-pre-wrap">
        {argsText}
      </pre>
    </div>
  );
...
function ToolFallbackResult({
  ...
  return (
    <div
      ...
      {...props}
    >
      <p className="aui-tool-fallback-result-header text-ui-muted-foreground text-xs font-medium">
        Result:
      </p>
      <pre className="aui-tool-fallback-result-content bg-ui-muted/50 text-foreground/90 mt-1 rounded-md p-2.5 text-xs whitespace-pre-wrap">
...
function ToolFallbackError({
  ...
  return (
    <div
      ...
      {...props}
    >
      <p className="aui-tool-fallback-error-header text-ui-muted-foreground font-semibold">
        {headerText}
      </p>
      <p className="aui-tool-fallback-error-reason text-ui-muted-foreground">
        {errorText}
      </p>
    </div>
  );
  ...
  if (confirming) {
    ...
    return (
      ...
      >
        ...
        {confirmDescription && (
          <p className="aui-tool-fallback-approval-confirm-description text-ui-muted-foreground">
            {confirmDescription}
          </p>
        )}
        {confirming.grants && confirming.grants.length > 0 && (
          <ul className="aui-tool-fallback-approval-confirm-grants flex flex-col gap-1">
            {confirming.grants.map((grant) => (
              <li key={grant}>
                <code className="aui-tool-fallback-approval-confirm-grant bg-ui-muted rounded px-1.5 py-0.5 text-xs">
                  {grant}
                </code>
              </li>
            ))}
