...
const AttachmentThumb: FC = () => {
  ...
  return (
    <Avatar className="aui-attachment-tile-avatar h-full w-full rounded-none">
      ...
      />
      <AvatarFallback>
        <FileText className="aui-attachment-tile-fallback-icon text-ui-muted-foreground/80 size-6 stroke-[1.5]" />
      </AvatarFallback>
    </Avatar>
  );
};
        ...
        >
          <AttachmentPreviewDialog>
            <TooltipTrigger render={<div className={cn(
                                        ...
                                        >
                                          <Loader2Icon className="text-ui-muted-foreground size-4 animate-spin" />
                                        </div>
                                      )}{isError && (
                                        <div
                                          aria-hidden="true"
...
export const ComposerAddAttachment: FC = () => {
  return (
    <ComposerPrimitive.AddAttachment render={<TooltipIconButton tooltip="Add Attachment" side="bottom" variant="ghost" size="icon" className="aui-composer-add-attachment text-ui-muted-foreground hover:text-foreground hover:bg-ui-muted-foreground/15 dark:border-ui-muted-foreground/15 dark:hover:bg-ui-muted-foreground/30 size-7 rounded-full active:scale-[0.96] motion-reduce:transition-none" aria-label="Add Attachment" />}><PlusIcon className="aui-attachment-add-icon size-4" /></ComposerPrimitive.AddAttachment>
  );
};
