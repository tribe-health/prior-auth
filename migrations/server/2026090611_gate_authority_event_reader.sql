-- RA06c-02. Flint Gate consumes the ASO authority snapshot and durable
-- outbox through a dedicated role. The deployment supplies a separate LOGIN
-- that is a member of this role; no credential belongs in schema source.
